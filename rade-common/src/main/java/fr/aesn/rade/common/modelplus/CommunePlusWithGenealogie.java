...
public class CommunePlusWithGenealogie {
  ...
  @Getter
  private final Map<String, GenealogieTypeAndEntity> parents;
  /** Map of Child Communes and modification details, indexed by codeINSEE. */
  @Getter
  private final Map<String, GenealogieTypeAndEntity> enfants;
  ...
  public void addParent(TypeGenealogieEntiteAdmin type,
    ...
    parents.put(entity.getCodeInsee(),
                new GenealogieTypeAndEntity(type, entity));
  }
   ...
   */
  @AllArgsConstructor
  public class GenealogieTypeAndEntity {
    /** Modification type. */
    @Getter
    private final TypeGenealogieEntiteAdmin type;
    /** Parent/Child Commune Entity. */
    @Getter
    private final Commune entity;
  }
}
