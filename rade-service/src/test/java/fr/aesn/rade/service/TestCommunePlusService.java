...
public class TestCommunePlusService
  ...
  public void getCommuneByCriteria() throws ParseException{
      ...
      assertEquals("Hibernate returned the wrong number of results",1, communes.size());
      communes = service.getCommuneByCriteria("91001",null,null,null,null,new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"));
      ...
      assertEquals("Hibernate returned the wrong number of results",1, communes.size());
      communes = service.getCommuneByCriteria(null,"91","03",null,null, new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"));
      assertEquals("Hibernate returned the wrong number of results",0, communes.size());
      ...
      assertEquals("Hibernate returned the wrong number of results",1, communes.size());
      communes = service.getCommuneByCriteria(null,"91","03",null,"éVi", new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"));
      assertEquals("Hibernate returned the wrong number of results",0, communes.size());
      communes = service.getCommuneByCriteria(null,"91","03",null,"éVi", new SimpleDateFormat("yyyy-MM-dd").parse("2018-01-01"));
      assertEquals("Hibernate returned the wrong number of results",1, communes.size());
      communes = service.getCommuneByCriteria(null,"91","03",null,"éVi", new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"));
      ...
      assertEquals("Hibernate returned the wrong number of results",1, communes.size());
      communes = service.getCommuneByCriteria(null,null,"03","11","éVi",new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"));
      assertEquals("Hibernate returned the wrong number of results",0, communes.size());
      communes = service.getCommuneByCriteria(null,null,"03","11",null,new SimpleDateFormat("yyyy-MM-dd").parse("2018-01-01"));
      assertEquals("Hibernate returned the wrong number of results",1, communes.size());
      communes = service.getCommuneByCriteria(null,null,"03","11",null,new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"));
      assertEquals("Hibernate returned the wrong number of results",0, communes.size());
      ...
      assertEquals("Hibernate returned the wrong number of results",1, communes.size());
       communes = service.getCommuneByCriteria(null,null,"03",null,"éVi",new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"));
      assertEquals("Hibernate returned the wrong number of results",0, communes.size());
      ...
      assertEquals("Hibernate returned the wrong number of results",3, communes.size());
      communes = service.getCommuneByCriteria(null,null,null,null,"éVi",new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"));
      assertEquals("Hibernate returned the wrong number of results",0, communes.size());
      ...
      communes = service.getCommuneByCriteria(null,null,null,null,null,new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"));
      assertEquals("Hibernate returned the wrong number of results",0, communes.size());
      communes = service.getCommuneByCriteria("91001","91","03","11","éVi",new SimpleDateFormat("yyyy-MM-dd").parse("2018-01-01"));
      assertEquals("Hibernate returned the wrong number of results",1, communes.size());
      communes = service.getCommuneByCriteria("91001","91","03","11","éVi",new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"));
      assertEquals("Hibernate returned the wrong number of results",0, communes.size());
      communes = service.getCommuneByCriteria(null,"91","03","11","aaa",new SimpleDateFormat("yyyy-MM-dd").parse("2018-01-01"));
      assertEquals("Hibernate returned the wrong number of results",0, communes.size());
      communes = service.getCommuneByCriteria(null,"91","03","11","aaa",new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"));
      assertEquals("Hibernate returned the wrong number of results",0, communes.size());
      communes = service.getCommuneByCriteria(null,"91",null,"11","éVi",new SimpleDateFormat("yyyy-MM-dd").parse("2018-01-01"));
      assertEquals("Hibernate returned the wrong number of results",3, communes.size());
      communes = service.getCommuneByCriteria(null,"91",null,"11","éVi",new SimpleDateFormat("yyyy-MM-dd").parse("2000-01-01"));
      assertEquals("Hibernate returned the wrong number of results",0, communes.size());
  }
}
