...
public class TestHexaposteImportBatch {
  ...
  @Configuration
  @ImportResource(locations = "classpath*:batch-job-hexaposte.xml")
  ...
  @Autowired
  protected HexaposteJpaDao hexaposteJpaDao;
  ...
  public void setUp() {
    ...
    jobLauncherTestUtils.setJob(context.getBean("importHexaposteJob", Job.class));
  }
  ...
  @Test
  public void testImportHexaposteJob() throws Exception {
    JobParametersBuilder jobBuilder = new JobParametersBuilder();
    jobBuilder.addString("inputFile", "classpath:batchfiles/hexaposte/extrait_hexapost38-NOV2011.txt");
    ...
    List<Hexaposte> list = hexaposteJpaDao.findAll();
