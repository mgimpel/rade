...
/**
 * Test the Region Batch Import Job.
 * @author Marc Gimpel (mgimpel@gmail.com)
 */
@RunWith(SpringJUnit4ClassRunner.class)
public class TestRegionImportBatch {
  ...
  @Autowired
  protected RegionJpaDao regionJpaDao;
  ...
  public void setUp() {
    ...
    jobLauncherTestUtils.setJob(context.getBean("importRegionInseeJob", Job.class));
  }
  ...
  @Test
  public void testImportRegionJob() throws Exception {
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    JobParametersBuilder jobBuilder = new JobParametersBuilder();
    jobBuilder.addString("inputFile", "classpath:batchfiles/insee/reg2018.txt");
