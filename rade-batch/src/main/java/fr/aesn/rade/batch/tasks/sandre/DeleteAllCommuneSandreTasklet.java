 ...
 */
@Slf4j
public class DeleteAllCommuneSandreTasklet
  implements Tasklet {
  /** Service for Commune Sandre. */
  @Autowired @Setter
  private CommuneSandreService communeSandreService;
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext)
    throws Exception {
    log.info("About to delete all Commune Sandre details.");
    communeSandreService.deleteAll();
